...
use asl_client_ffi::{
    ASL_ANNONCE, ASL_ARGUMENT, ASL_CHAINE_REFUSEE, ASL_CONFIGURATION, ASL_DEJA, ASL_EN_COURS,
...
fn les_constantes_de_l_en_tete_sont_celles_de_rust() {
    ...
    let attendues: [(&str, i64); 38] = [
        ...
        (
            "ASL_ADRESSE_OCTETS",
            i64::try_from(appareil::ASL_ADRESSE_OCTETS).expect("il tient"),
        ),
        (
