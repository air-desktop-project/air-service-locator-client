...
private fun lEnteteEstLaReference() {
    ...
    val transcrites = mapOf(
        ...
        "CHAINE_REFUSEE" to Abi.CHAINE_REFUSEE, "TROP_D_ESSAIS" to Abi.TROP_D_ESSAIS,
        ...
        "ATTESTATION_MAX" to Abi.ATTESTATION_MAX, "NOUVELLE_MAX" to Abi.NOUVELLE_MAX,
        "ADRESSE_OCTETS" to Abi.ADRESSE_OCTETS,
        "PLATEFORME_AUCUNE" to Abi.PLATEFORME_AUCUNE, "PLATEFORME_APPLE" to Abi.PLATEFORME_APPLE,
        "PLATEFORME_ANDROID" to Abi.PLATEFORME_ANDROID, "PLATEFORME_INVITATION" to Abi.PLATEFORME_INVITATION,
    )
